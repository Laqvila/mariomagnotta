...
const I18N = {
  ...
  "promo.title":  { it:"Il vinile della Lavatrice, copia unica", en:"The washing-machine prank on vinyl, one of a kind", es:"El vinilo de la lavadora, copia única" },
  "promo.text":   {
    it:"Un 33 giri in un solo esemplare, firmato da Romina Magnotta, dagli autori dello scherzo e dai protagonisti di «Semplice Cliente». Andrà all'asta e tutto il ricavato sarà per Romina, la figlia di Mario.",
    en:"A 33 rpm record in a single copy, signed by Romina Magnotta, by the authors of the prank and by the people behind «Semplice Cliente». It goes to auction and all proceeds go to Romina, Mario's daughter.",
    es:"Un 33 revoluciones en un solo ejemplar, firmado por Romina Magnotta, por los autores de la broma y por los protagonistas de «Semplice Cliente». Saldrá a subasta y toda la recaudación será para Romina, la hija de Mario." },
  "promo.cta":    { it:"Scopri di più", en:"Find out more", es:"Descubre más" },
  "promo.close":  { it:"Chiudi", en:"Close", es:"Cerrar" },
  ...
  "shop.intro":   {
    it:"Magliette, poster, portachiavi, l'action figure, la birra e la camomilla di Mario si acquistano su <strong>magnottaofficial.com</strong>.",
    en:"T-shirts, posters, keyrings, the action figure, the beer and Mario's camomile tea are sold at <strong>magnottaofficial.com</strong>.",
    es:"Camisetas, pósters, llaveros, la figura de acción, la cerveza y la manzanilla de Mario se compran en <strong>magnottaofficial.com</strong>." },
  ...
  "shop.disclaimer": {
    it:"Link a sito esterno. Lo store magnottaofficial.com <strong>non è gestito da mariomagnotta.com</strong>: prezzi, disponibilità, vendite, pagamenti, spedizioni, resi e trattamento dei dati sono di esclusiva responsabilità del suo gestore e regolati dalle sue condizioni.",
    en:"External link. The magnottaofficial.com store <strong>is not operated by mariomagnotta.com</strong>: prices, availability, sales, payments, shipping, returns and data processing are the sole responsibility of its operator and governed by its own terms.",
    es:"Enlace externo. La tienda magnottaofficial.com <strong>no está gestionada por mariomagnotta.com</strong>: precios, disponibilidad, ventas, pagos, envíos, devoluciones y tratamiento de datos son responsabilidad exclusiva de su gestor y se rigen por sus propias condiciones." },
  ...
  "privacy.body": {
    it:"<p>Questo sito non raccoglie dati personali a fini di marketing e non usa cookie di profilazione. Vengono utilizzati esclusivamente <strong>cookie tecnici</strong> necessari al funzionamento e, se acconsenti, il <code>localStorage</code> per ricordare la lingua e la tua scelta sui cookie.</p><p>Per le statistiche di visita usiamo <strong>Cloudflare Web Analytics</strong>: raccoglie solo dati aggregati e anonimi (numero di visite, pagine viste, provenienza generica, tipo di dispositivo) <strong>senza cookie</strong> e senza memorizzare nulla sul tuo dispositivo, senza profilazione né tracciamento tra siti diversi. Per questo non richiede il tuo consenso. Base giuridica: legittimo interesse del titolare (art. 6.1.f GDPR). Fornitore tecnico: Cloudflare, Inc.</p><p>I <strong>video e gli audio</strong> sono incorporati da <strong>YouTube</strong> (Google Ireland Ltd.) in modalità privacy avanzata e vengono caricati <strong>solo dopo il tuo consenso esplicito</strong>. Quando li carichi, YouTube può installare propri cookie secondo la <a href='https://policies.google.com/privacy' target='_blank' rel='noopener'>privacy policy di Google</a>.</p><p>Puoi revocare il consenso in qualsiasi momento cancellando i dati del sito dal tuo browser. Titolare: mariomagnotta.com — contatto: info@mariomagnotta.com.</p>",
    en:"<p>This website does not collect personal data for marketing and uses no profiling cookies. Only <strong>technical cookies</strong> necessary for operation are used and, with your consent, <code>localStorage</code> to remember your language and cookie choice.</p><p>For visit statistics we use <strong>Cloudflare Web Analytics</strong>: it collects only aggregated, anonymous data (number of visits, page views, general referrer, device type) <strong>without cookies</strong> and without storing anything on your device, with no profiling or cross-site tracking. For this reason it does not require your consent. Legal basis: the owner's legitimate interest (Art. 6(1)(f) GDPR). Technical provider: Cloudflare, Inc.</p><p><strong>Videos and audio</strong> are embedded from <strong>YouTube</strong> (Google Ireland Ltd.) in privacy-enhanced mode and load <strong>only after your explicit consent</strong>. Once loaded, YouTube may set its own cookies under <a href='https://policies.google.com/privacy' target='_blank' rel='noopener'>Google's privacy policy</a>.</p><p>You can withdraw consent at any time by clearing the site data from your browser. Controller: mariomagnotta.com — contact: info@mariomagnotta.com.</p>",
    es:"<p>Este sitio no recoge datos personales con fines de marketing y no usa cookies de perfilado. Solo se utilizan <strong>cookies técnicas</strong> necesarias para el funcionamiento y, con tu consentimiento, <code>localStorage</code> para recordar el idioma y tu elección sobre las cookies.</p><p>Para las estadísticas de visitas usamos <strong>Cloudflare Web Analytics</strong>: recoge solo datos agregados y anónimos (número de visitas, páginas vistas, procedencia genérica, tipo de dispositivo) <strong>sin cookies</strong> y sin almacenar nada en tu dispositivo, sin perfilado ni seguimiento entre sitios. Por ello no requiere tu consentimiento. Base jurídica: interés legítimo del titular (art. 6.1.f RGPD). Proveedor técnico: Cloudflare, Inc.</p><p>Los <strong>vídeos y audios</strong> están incrustados desde <strong>YouTube</strong> (Google Ireland Ltd.) en modo de privacidad mejorada y se cargan <strong>solo tras tu consentimiento explícito</strong>. Al cargarlos, YouTube puede instalar sus propias cookies según la <a href='https://policies.google.com/privacy' target='_blank' rel='noopener'>política de privacidad de Google</a>.</p><p>Puedes retirar el consentimiento en cualquier momento borrando los datos del sitio en tu navegador. Responsable: mariomagnotta.com — contacto: info@mariomagnotta.com.</p>" },
...
const CHICCHE = [
  ...
  { icona:"💸", t:L("La banconota da 480.000 lire","The 480,000-lire banknote","El billete de 480.000 liras"), d:L("La celebre banconota da «quattrocentoottantamila» lire — «pagabili a vista al portatore» — con il volto di Mario è opera di <strong>Davide Francesco Isola</strong>.","The famous «four-hundred-eighty-thousand» lire banknote — «payable on demand to the bearer» — featuring Mario's face is the work of <strong>Davide Francesco Isola</strong>.","El célebre billete de «cuatrocientos ochenta mil» liras — «pagaderas a la vista al portador» — con el rostro de Mario es obra de <strong>Davide Francesco Isola</strong>."), img:"assets/img/banconota-480000.jpg" },
